...
class developer:
    def __init__(self,shrey):
        ...
        img=Image.open(r"C:\Users\sva16\OneDrive\Desktop\faceattendancesystem\faceattendancesystem\images\222.jpg")
        ...
        img2=Image.open(r"C:\Users\sva16\OneDrive\Desktop\faceattendancesystem\faceattendancesystem\images\srihansh..jpg")
        ...
        labl1=Label(Left_course, text="Name - Srihansh kumar", font=("times new roman",20,"bold"))
        ...
        labl4=Label(Left_course, text="Contact - 6388714912", font=("times new roman",20,"bold"))
        labl4.place(x=5,y=130)
        labl5=Label(Left_course, text="Location - Kanpur", font=("times new roman",20,"bold"))
